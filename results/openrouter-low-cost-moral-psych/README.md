...
OpenRouter pricing metadata fetched: `2026-05-27T14:08:56.432880+00:00` from `https://openrouter.ai/api/v1/models`.
...
Sample limit for this plan: `1` per task.
Eligible model count: `17`. Skipped model count: `0`.
Estimated total run cost for this plan: `$0.0119`.
...
Conservative observed API cost estimate from Inspect logs: `$0.008199`.
