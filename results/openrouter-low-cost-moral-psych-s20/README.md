...
OpenRouter pricing metadata fetched: `2026-05-27T14:13:06.018042+00:00` from `https://openrouter.ai/api/v1/models`.
...
Sample limit for this plan: `20` per task.
Eligible model count: `17`. Skipped model count: `0`.
Estimated total run cost for this plan: `$0.2417`.
...
Conservative observed API cost estimate from Inspect logs: `$0.167436`.
Observed reasoning tokens: `306036`.
Models with reasoning tokens despite controls: `deepseek/deepseek-v4-flash, qwen/qwen3-32b, qwen/qwen3.5-9b`.
