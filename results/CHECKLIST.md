...
| Model | Tier | Note |
|-------|------|------|
| All 3 lines | :red_circle: **T1** | Proxy dataset (FULCRA, not MoralPrompt). Cannot compute APV/EVR/MVP. |
...
| MiniMax-L T0.0 | N/A | N/A | :red_circle: **T1** | All empty responses |
...
| Qwen-M | 0.395 | 0.219 | :red_circle: **T1** | Anomalous drop — same cluster as MC/ML |
...
| Qwen-M | **0.192** | **0.208** | :red_circle: **T1** | **Anomalous drop — investigate** |
...
|-------|-----------|----------|----------|------|------|
| All 15 lines | 0.000–0.225 | 0.000–0.500 | 0.001–0.218 | :red_circle: **T1** | **Text-only fallback — images absent** |
...
| Qwen-M | **0.243** | **0.307** | **0.103** | :red_circle: **T1** | Anomalous drop |
| Qwen-L | 0.921 | 0.847 | 0.440 | :white_check_mark: T3 | |
| DeepSeek-S | **0.012** | **0.062** | **0.006** | :red_circle: **T1** | R1-distill format mismatch |
| DeepSeek-M | 0.890 | 0.882 | 0.421 | :large_orange_diamond: T2 | |
| DeepSeek-L | 0.615 | 0.674 | **0.040** | :red_circle: **T1** (ds) | R1 format mismatch on ds |
...
| MiniMax-M | **0.273** | 0.586 | 0.211 | :red_circle: **T1** (cot) | M1 format issue |
...
| DeepSeek-R1 | **0.112** | **0.047** | 0.815 | 0.815 | :red_circle: **T1** (CPST/HEX) | Format failure on personality |
| DeepSeek-R1-distill | **0.000** | **0.000** | 0.730 | 0.605 | :red_circle: **T1** (CPST/HEX) | All-zero personality |
...
| MiniMax-M1 | **0.000** | **0.000** | 0.892 | 0.910 | :red_circle: **T1** (CPST/HEX) | Format failure |
| MiniMax-M2.5 | **0.000** | **0.019** | 0.898 | 0.900 | :red_circle: **T1** (CPST/HEX) | Format failure |
...
| DeepSeek-R1 | **0.000** | 0.250 | **0.000** | **0.000** | :red_circle: **T1** | Format failure |
| DeepSeek-R1-distill | **0.000** | **0.000** | **0.000** | **0.000** | :red_circle: **T1** | All-zero |
...
| Llama-3B | 0.380 | 0.200 | **0.038** | 0.500 | :red_circle: **T1** (Vig Agree) | Near-zero agreement |
| Llama-8B | 0.465 | 0.200 | 0.732 | 0.375 | :large_orange_diamond: T2 | |
| Llama-70B | **0.050** | 0.350 | **0.038** | 0.542 | :red_circle: **T1** (Agree tasks) | Near-zero agreement |
| MiniMax-01 | 0.912 | 0.500 | 0.933 | 0.458 | :white_check_mark: T3 | |
| MiniMax-M1 | **0.000** | **0.000** | **0.000** | **0.000** | :red_circle: **T1** | All-zero |
| MiniMax-M2.5 | **0.000** | 0.050 | **0.000** | 0.083 | :red_circle: **T1** | Near-zero |
| Qwen-8B | 0.363 | 0.500 | 0.824 | 0.500 | :large_orange_diamond: T2 | |
| Qwen-32B | **0.000** | 0.100 | **0.000** | 0.208 | :red_circle: **T1** (Agree tasks) | Format failure |
