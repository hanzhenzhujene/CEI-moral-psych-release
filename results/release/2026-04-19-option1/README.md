...
- [family scaling profile](../../../figures/release/option1_family_scaling_profile.svg): five-panel family view with three accuracy trajectories plus two status-curve panels for CCD-Bench and Denevil
