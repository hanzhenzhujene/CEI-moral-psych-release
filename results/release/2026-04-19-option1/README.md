...
- [paper-vs-current replication map](../../../figures/release/option1_paper_result_alignment_map.svg): visual map with paper-side numeric anchors, current repo numbers, current-only rows, blocked model routes, and proxy-only evidence
