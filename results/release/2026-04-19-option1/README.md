...
- [same-model paper calibration bars](../../../figures/release/option1_paper_result_alignment_map.svg): strict bar comparison for exact CCD-Bench paper-model rows with a shared Nordic-share metric
