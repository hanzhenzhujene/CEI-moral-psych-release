...
run_family() {
  ...
  case "$family" in
    llama_text)
      ...
      run_task "$family" "unimoral_moral_typology" "src/inspect/evals/unimoral.py::unimoral_moral_typology" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_factor_attribution" "src/inspect/evals/unimoral.py::unimoral_factor_attribution" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_consequence_generation" "src/inspect/evals/unimoral.py::unimoral_consequence_generation" "$TEXT_MAX_CONNECTIONS"
