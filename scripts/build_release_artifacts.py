...
BENCHMARK_METADATA = {
    ...
    "CCD-Bench": {
        ...
        "current_release_scope": "Ten-option cultural-choice selection/distribution",
...
PAPER_RESULT_ALIGNMENT_ROWS = [
    {
        ...
        "paper_results_available_in_repo": "Visible paper metric anchors for RQ1-RQ4 are tracked in paper-result-comparison.csv. A fresh exact Llama 3.1 8B UniMoral RQ1-RQ4 rerun is summarized in results/paper-calibration-exact-20260706-unimoral-llama31/calibration-summary.csv; saved/prior May 13 UniMoral values remain available for Mistral Nemo 0.648110, Qwen2.5 7B 0.640255, Llama 3.1 8B action 0.638775, Llama 3 8B 0.631831, and Llama 3.2 1B 0.405624.",
        ...
        "same_model_overlap_or_context": "Fresh exact Llama 3.1 8B overlap now exists for UniMoral RQ1-RQ4. DeepSeek current rows are context only because they are not the same as the paper-named 8B distill route; Phi remains unavailable as an exact OpenRouter route.",
        "paper_only_models_or_routes": "Phi-3.5-mini-instruct and DeepSeek-R1-Distill-Llama-8B remain unavailable as exact OpenRouter routes in this pass.",
        ...
        "comparison_status": "fresh_exact_model_overlap_metric_bridge",
        "can_compare_directly": "Partly. The exact Llama 3.1 8B model identity now matches for UniMoral RQ1-RQ4, but paper and release scoring are related rather than identical, so compare task coverage and metric-bridged direction rather than a one-number delta.",
        ...
        "reviewer_takeaway": "Use UniMoral as the clearest paper-to-current task bridge, while labeling the fresh Llama 3.1 8B overlap as metric-bridged calibration and GPT-5.5 as a current text-only reference.",
        "evidence_sources": "results/paper-calibration-exact-20260706-unimoral-llama31/calibration-summary.csv; unimoral-full-benchmark.csv; results/exploratory/2026-05-13-additional-model-sweep/unimoral-summary.csv; docs/calibration-replication.md; local reference checkout for UniMoral RQ1 code.",
    },
    {
        "benchmark": "SMID",
        ...
        "same_model_overlap_or_context": "None. This is a current benchmark comparison layer rather than paper-model replication.",
    ...
    },
    {
        ...
        "same_model_overlap_or_context": "None. Prompt-based LLM rows are not Kaleido model replication.",
    ...
    },
    {
        ...
        "paper_results_available_in_repo": "Reference CCD summaries are available locally. Example reference values: Mistral Nemo model-bias score 0.137427, entropy 3.210635, multi-dimensional rate 81.989%. The fresh exact Mistral Nemo rerun has 2,182/2,182 valid choices, dominant Nordic Europe share 25.573%, and 7.238 effective clusters.",
        "current_repo_result_surface": "Current release reports line-level CCD choice distributions in ccd-choice-distribution.csv, not accuracy. The strict same-model calibration bridge now includes exact current Llama-4 plus fresh exact CCD reruns for Mistral Nemo, Llama-3.3-70B-Instruct, DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, WizardLM-2-8x22B, Perplexity Sonar, and Claude 4 Sonnet.",
        "same_model_overlap_or_context": "Exact overlap exists for current Llama-4-Maverick-17B-128E-Instruct / Llama-L and fresh July 2026 exact CCD reruns for Mistral Nemo, Llama-3.3-70B-Instruct, DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, WizardLM-2-8x22B, Perplexity Sonar, and Claude 4 Sonnet.",
        "paper_only_models_or_routes": "Remaining unverified or unavailable exact routes include ChatGPT-4o-latest, Gemini 2.0/2.5 Flash, Claude 3.7 Sonnet, Jamba 1.6, and Grok-2.",
        ...
        "can_compare_directly": "Partly. The same-model bridge includes current Llama-4-Maverick-17B-128E-Instruct and fresh verified CCD distribution rows for Mistral Nemo, Llama-3.3-70B-Instruct, DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, GPT-4.1, Command-R, Phi-4, WizardLM, Sonar, and Claude 4 Sonnet; the metric is distribution/concentration rather than accuracy. Non-exact rows stay out of one-to-one calibration visuals.",
        ...
        "reviewer_takeaway": "CCD-Bench needs a visual/map rather than a winner table: compare only exact same-model distribution evidence when calibrating to the paper, keep failed/cancelled/unavailable/non-exact rows as ledger context only, and remove all accuracy language.",
        "evidence_sources": "ccd-choice-distribution.csv; results/exploratory/2026-05-13-additional-model-sweep/ccd-summary.csv; results/paper-calibration-exact-20260705/calibration-summary.csv; docs/calibration-replication.md; local reference checkout for CCD-Bench multi_model_analysis/model_summary_comparison.csv.",
    },
    {
        ...
        "same_model_overlap_or_context": "None for paper-faithful DeNEVIL. Any current row is proxy-only behavior/provenance.",
...
PAPER_RESULT_COMPARISON_ROWS = [
    ...
    },
    {
        ...
        "our_exact_result": "Same-model rows include current Llama-4 and fresh July 2026 exact CCD reruns: Mistral Nemo 25.6%, Llama-3.3 20.8%, DeepSeek 23.2%, Qwen 21.1%, GPT-4.1 22.3%, Command-R 22.7%, Phi-4 20.7%, WizardLM 23.6%, Sonar 14.3%, and Claude 4 Sonnet 30.2% Nordic Europe dominant-cluster share.",
        "our_closest_line": "Strict bridge rows: Llama-L current release plus fresh exact CCD reruns",
        "comparison_status": "Same-model behavioral bridge; CCD-Bench is not accuracy",
        "same_model_overlap": "Exact same-model overlap exists for current Llama-4-Maverick-17B-128E-Instruct / Llama-L and fresh July 2026 exact reruns for Mistral Nemo, Llama-3.3-70B-Instruct, DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, WizardLM-2-8x22B, Perplexity Sonar, and Claude 4 Sonnet.",
        "reviewer_takeaway": "Use the strict bridge for one-to-one CCD distribution calibration. Treat cancelled, failed, unavailable, and non-exact rows as ledger context only.",
...
PAPER_MODEL_OVERLAP_ROW_VALUES = [
    ...
    ("UniMoral", "Llama-3.1-8B Instruct", "RQ1-RQ4 paper tables include this model", "Fresh exact Llama 3.1 8B UniMoral rerun", "RQ1 accuracy 0.6219; RQ2 accuracy 0.6022; RQ3 accuracy 0.5948; RQ4 METEOR 0.1212 and BERTScore F1 0.6555", "Exact same-model fresh rerun evidence with metric-scale caveats", "Use as UniMoral model-identity calibration; do not call it reproduced paper weighted-F1/BERTScore tables."),
    ("UniMoral", "DeepSeek-R1-Distill-Llama-8B", "Paper table model", "DeepSeek-S", "DeepSeek-S action accuracy 0.661", "Not exact model; context only; not plotted in the same-model calibration bridge", "Do not call it exact replication."),
    ...
    ("CCD-Bench", "Claude 4 Sonnet", "top Nordic Europe 30.6%; Germanic Europe 15.9%; plural rationales 98.6%; Cramer's V 0.054", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 30.2475%; effective clusters 6.041", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "Command-R 08-2024", "top Nordic Europe 16.1%; Germanic Europe 10.2%; plural rationales 78.5%; Cramer's V 0.142", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 22.6856%; effective clusters 7.844", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "DeepSeek-chat-v3-0324", "top Nordic Europe 22.9%; Germanic Europe 11.9%; plural rationales 96.8%; Cramer's V 0.161", "Fresh exact CCD rerun", "2,108/2,182 valid choices; option_6 Nordic Europe 23.2448%; effective clusters 7.905", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge with valid-choice gap caveat, not accuracy."),
    ...
    ("CCD-Bench", "Llama-3.3-70B-Instruct", "top Nordic Europe 19.7%; Germanic Europe 15.3%; plural rationales 85.3%; Cramer's V 0.203", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 20.8066%; effective clusters 7.980", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "Llama-4-Maverick-17B-128E-Instruct", "top Nordic Europe 21.1%; Germanic Europe 14.6%; plural rationales 68.6%; Cramer's V 0.097", "Llama-L", "Llama-L: 2,013/2,182 valid choices; option_6 Nordic Europe 23.5%; effective clusters 7.67", "Exact same-model current release evidence", "Use as a CCD distribution bridge with valid-choice gap caveat, not accuracy."),
    ("CCD-Bench", "Microsoft Phi-4", "top Nordic Europe 18.9%; Germanic Europe 7.8%; plural rationales 82.7%; Cramer's V 0.152", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 20.6691%; effective clusters 8.511", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "WizardLM-2-8x22B", "top Nordic Europe 22.0%; Germanic Europe 16.4%; plural rationales 88.8%; Cramer's V 0.111", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 23.6480%; effective clusters 7.498", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "Mistral Nemo", "top Nordic Europe 19.0%; Germanic Europe 13.1%; plural rationales 82.0%; Cramer's V 0.130", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 25.5729%; effective clusters 7.238", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "OpenAI ChatGPT-4o-latest", "top Nordic Europe 18.4%; Germanic Europe 11.5%; plural rationales 96.8%; Cramer's V 0.186", "GPT-4o-mini Ref", "GPT-4o-mini Ref: option_6 (Nordic Europe) at 17.1%; effective clusters 8.94", "OpenAI reference family only, not exact model variant; not plotted in the same-model calibration bridge", "Use only as current OpenAI context; not an OpenAI S/M/L family-size sweep and not paper-model calibration."),
    ("CCD-Bench", "OpenAI GPT-4.1", "top Nordic Europe 21.5%; Germanic Europe 7.6%; plural rationales 94.7%; Cramer's V 0.096", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 22.2731%; effective clusters 8.298", "Exact same-model fresh rerun evidence", "Use as CCD paper-model calibration only; it is not an OpenAI S/M/L family-size sweep."),
    ("CCD-Bench", "Perplexity Sonar", "top Nordic Europe 21.8%; Germanic Europe 12.5%; plural rationales 92.9%; Cramer's V 0.127", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 14.3446%; effective clusters 9.570", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not accuracy."),
    ("CCD-Bench", "Qwen2.5-72B-Instruct", "top Nordic Europe 17.7%; Germanic Europe 9.4%; plural rationales 91.4%; Cramer's V 0.102", "Fresh exact CCD rerun", "2,182/2,182 valid choices; option_6 Nordic Europe 21.1274%; effective clusters 8.422", "Exact same-model fresh rerun evidence", "Use as a CCD distribution bridge, not Qwen-L substitution."),
...
PAPER_MODEL_CALIBRATION_LEDGER_ROWS = [
    {
        ...
        "repo_result_anchor": "Fresh exact UniMoral rerun: RQ1 accuracy 0.621926; RQ2 accuracy 0.602234; RQ3 accuracy 0.594788; RQ4 live METEOR 0.121226; RQ4 offline BERTScore F1 0.655539.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260706-unimoral-llama31/calibration-summary.csv; results/exploratory/2026-05-13-additional-model-sweep/unimoral-summary.csv",
        "calibration_action": "Use as fresh exact same-model UniMoral calibration with metric-scale caveats; RQ4 now has both repo-side METEOR and BERTScore F1.",
        "comparison_boundary": "Same model and same task family, but paper reports weighted F1 / 0-100 generation metrics while the repo reports 0-1 accuracy / generation metrics.",
    },
    {
        "benchmark": "UniMoral RQ1-RQ4",
    ...
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 25.5729%; effective clusters 7.237951.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
    ...
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 20.8066%; effective clusters 7.980242.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,108/2,182 valid choices; Nordic Europe 23.2448%; effective clusters 7.904934.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge with valid-choice gap caveat.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; do not substitute the DeepSeek-M release row.",
    },
    {
        "benchmark": "CCD-Bench",
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 21.1274%; effective clusters 8.422117.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; do not substitute Qwen-L.",
    },
    {
        "benchmark": "CCD-Bench",
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 22.2731%; effective clusters 8.298111.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; do not substitute GPT-4.1-mini or GPT-4.1-nano.",
    },
    {
        "benchmark": "CCD-Bench",
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 22.6856%; effective clusters 7.843516.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 20.6691%; effective clusters 8.511400.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 23.6480%; effective clusters 7.498376.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 14.3446%; effective clusters 9.570060.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
    },
    {
        ...
        "repo_result_anchor": "Fresh exact CCD rerun: 2,182/2,182 valid choices; Nordic Europe 30.2475%; effective clusters 6.041300.",
        "repo_evidence_state": "current_fresh_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Use as exact same-model CCD distribution bridge.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
    },
    {
        ...
        "repo_result_anchor": "Current release row Llama-L: 2,013/2,182 valid choices; Nordic Europe 23.546945%; effective clusters 7.665547. OpenRouter metadata describes meta-llama/llama-4-maverick as Llama 4 Maverick 17B Instruct (128E).",
...
PAPER_MODEL_CALIBRATION_BRIDGE_ROWS = [
    {
        "benchmark": "UniMoral",
        "paper_model": "Llama-3.1-8B Instruct",
        "repo_model_or_line": "fresh exact UniMoral rerun",
        "model_match_class": "exact_same_model",
        "evidence_state": "current_fresh_verified",
        "fresh_rerun": "yes",
        "task_scope": "RQ1-RQ4 fresh exact rerun; RQ4 has live METEOR and offline BERTScore F1",
        ...
        "repo_metric": "Accuracy for RQ1-RQ3; live METEOR and offline BERTScore F1 for RQ4",
        "repo_value": "RQ1 0.621926; RQ2 0.602234; RQ3 0.594788; RQ4 METEOR 0.121226; RQ4 BERTScore F1 0.655539",
        "valid_n": "17550",
        "total_n": "17550",
        ...
        "source_artifacts": "results/paper-calibration-exact-20260706-unimoral-llama31/calibration-summary.csv; ACL paper Tables 4-7",
    },
    {
        "benchmark": "CCD-Bench",
        "paper_model": "Mistral Nemo",
        "repo_model_or_line": "fresh exact CCD rerun",
        "model_match_class": "exact_same_model",
        "evidence_state": "current_fresh_verified",
        "fresh_rerun": "yes",
        ...
        "comparison_boundary": "CCD is distributional behavior, not accuracy.",
        "source_artifacts": "results/paper-calibration-exact-20260705/calibration-summary.csv; CCD-Bench reference model_summary_comparison.csv",
    },
    {
        "benchmark": "CCD-Bench",
        "paper_model": "Llama-3.3-70B-Instruct",
    ...
    },
    {
        "benchmark": "CCD-Bench",
        "paper_model": "Llama-4-Maverick-17B-128E-Instruct",
        "repo_model_or_line": "Llama-L current release row",
        "model_match_class": "exact_same_model",
        ...
        "paper_value": "0.211",
        "repo_metric": "Nordic Europe dominant-cluster share",
        "repo_value": "0.23546945",
        "valid_n": "2013",
        "total_n": "2182",
        "can_plot_numeric": "yes",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; current row has valid-choice gaps.",
        "source_artifacts": "results/release/2026-04-19-option1/ccd-choice-distribution.csv; CCD-Bench reference model_summary_comparison.csv; OpenRouter model metadata",
    },
    {
        "benchmark": "CCD-Bench",
        "paper_model": "DeepSeek-chat-v3-0324",
        ...
        "total_n": "2182",
        "can_plot_numeric": "yes",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; fresh rerun has valid-choice gaps.",
        "source_artifacts": "results/paper-calibration-exact-20260705/calibration-summary.csv; CCD-Bench reference model_summary_comparison.csv",
    },
    {
        "benchmark": "CCD-Bench",
        ...
        "total_n": "2182",
        "can_plot_numeric": "yes",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; routed rerun excluded Novita after provider endpoint failure.",
        "source_artifacts": "results/paper-calibration-exact-20260705/calibration-summary.csv; CCD-Bench reference model_summary_comparison.csv",
    },
    {
        "benchmark": "CCD-Bench",
        ...
        "total_n": "2182",
        "can_plot_numeric": "yes",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; this is an exact paper-model CCD row, not an OpenAI family-size sweep.",
        "source_artifacts": "results/paper-calibration-exact-20260705/calibration-summary.csv; CCD-Bench reference model_summary_comparison.csv",
    },
    {
        "benchmark": "CCD-Bench",
    ...
    },
    {
        ...
        "total_n": "2182",
        "can_plot_numeric": "yes",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; this row is notably more diffuse than the paper anchor.",
        "source_artifacts": "results/paper-calibration-exact-20260705/calibration-summary.csv; CCD-Bench reference model_summary_comparison.csv",
    },
    {
        "benchmark": "CCD-Bench",
...
def render_coverage_svg(rows: list[dict[str, Any]], output_path: Path) -> None:
    ...
    lines.extend(
        [
            ...
            "<title>Frozen Option 1 coverage: Qwen, DeepSeek, Gemma</title>",
            "<desc>Coverage matrix for the frozen Option 1 release slice across Qwen, DeepSeek, and Gemma only. Green cells are benchmark-faithful paper-setup rows, amber cells are proxy-only, and hatched gray cells were not part of that frozen release slice.</desc>",
            '<text x="48" y="64" class="title">Frozen Option 1 Coverage: Qwen, DeepSeek, Gemma</text>',
            *svg_text_block(
                48,
                88,
                "This matrix is the frozen Option 1 slice only: Qwen, DeepSeek, and Gemma. Green cells follow the paper setup; amber cells are proxy-only; hatched gray cells were not part of that release slice.",
                "subtitle",
                132,
            ),
        ]
...
def render_paper_result_alignment_svg(rows: list[dict[str, Any]], output_path: Path) -> None:
    ...
    legend_y = height - 72
    lines.append(f'<rect x="48" y="{legend_y - 22}" width="{width - 96}" height="46" rx="16" class="legend-card"/>')
    lines.append(f'<rect x="72" y="{legend_y - 6}" width="18" height="12" rx="6" fill="{paper_color}"/>')
...
def append_paper_result_alignment_table(lines: list[str], rows: list[dict[str, Any]], csv_path: str, doc_path: str) -> None:
    overview = {
        "UniMoral": {
            ...
            "compare": "Same-model calibration is available, with metric-scale caveats; RQ4 has METEOR and BERTScore.",
        },
        "SMID": {
...
def append_benchmark_result_visuals_section(lines: list[str], figure_prefix: str) -> None:
    lines.extend(
        [
            ...
            "",
            f"![UniMoral four-task dashboard]({figure_prefix}/option1_unimoral_four_task_dashboard.svg)",
            "",
            ...
            "",
            f"![Comparable accuracy heatmap]({figure_prefix}/option1_accuracy_heatmap.svg)",
            "",
            ...
            "",
            f"![Same-model CCD calibration bar chart]({figure_prefix}/option1_paper_result_alignment_map.svg)",
            "",
            ...
            "",
            f"![Same-model paper calibration bridge]({figure_prefix}/option1_paper_model_calibration_bridge.svg)",
            "",
            ...
            "",
            f"![Paper-result context table]({figure_prefix}/option1_paper_result_comparison.svg)",
            "",
...
def append_interpretation_sections(
    ...
    lines.append(
        f"| Tightest comparable spread | `UniMoral` has the tightest range, from {fmt_float(unimoral_summary['min_accuracy'])} to {fmt_float(unimoral_summary['max_accuracy'])} ({fmt_float(unimoral_summary['spread'])} spread). | Most text models are already in the same band on the basic human-choice layer, but this is not proof of benchmark saturation. The more useful story is which UniMoral subtask each model handles best. |"
    )
    lines.append(
...
def append_figure_gallery(lines: list[str], figure_prefix: str) -> None:
    lines.extend(
        [
            "## Supporting Figures",
            "",
            "The main result and calibration visuals are embedded above in context; this gallery keeps QA/provenance links and the generated figure set together without repeating the surrounding interpretation text.",
            "",
            ...
            f"| Figure 19 | Context-only paper-result table for paper metric anchors that are not same-model bar comparisons. | {markdown_link('option1_paper_result_comparison.svg', f'{figure_prefix}/option1_paper_result_comparison.svg')} |",
            "",
            ...
            "",
            "_Figure 15. Frozen Option 1 coverage matrix for Qwen, DeepSeek, and Gemma only; broader family-size/OpenAI rows are tracked in progress/readiness tables._",
            "",
            ...
            f"![Same-model CCD calibration bar chart]({figure_prefix}/option1_paper_result_alignment_map.svg)",
            "",
            "_Figure 17. Same-model calibration bars for CCD-Bench rows with a shared Nordic-share metric; non-exact and metric-mismatched rows stay in the ledger._",
            "",
...
def append_main_result_file_map(lines: list[str], figure_prefix: str) -> None:
    lines.extend(
        [
            ...
            "| --- | --- | --- | --- |",
            "| `UniMoral RQ1-RQ4` | primary result: `results/release/2026-04-19-option1/unimoral-full-benchmark.csv`<br/>model rankings: `results/release/2026-04-19-option1/unimoral-model-rankings.csv`<br/>sample-level predictions: `results/release/2026-04-19-option1/unimoral-sample-predictions.csv`<br/>sample-level BERTScore audit: `results/release/2026-04-19-option1/unimoral-rq4-bertscore.csv` | RQ1-RQ3 use exact-match accuracy. RQ4 is generation quality and appears as two metric rows per model: BERTScore F1 for semantic overlap and METEOR for lexical overlap. Do not collapse RQ1-RQ4 into one universal moral score. | `option1_unimoral_task_heatmap.svg`, `option1_unimoral_generation_quality.svg`, and `option1_unimoral_family_scaling.svg` under `figures/release/`. Rebuild with `make release` or `make release VENV_PYTHON=/path/to/python` when no local `.venv` exists. |",
            ...
            "| OpenRouter selected-grid follow-up | `results/openrouter-selected-grid-moral-psych-full/result_summary.csv`<br/>`results/openrouter-selected-grid-moral-psych-full/benchmark_summary.csv`<br/>`results/openrouter-selected-grid-moral-psych-full/model_summary.csv`<br/>`results/openrouter-selected-grid-moral-psych-full/README.md`<br/>`results/openrouter-selected-grid-moral-psych-full/interpretation.md`<br/>`results/openrouter-selected-grid-moral-psych-full/completion_audit.md`<br/>`results/openrouter-selected-grid-moral-psych-full/targeted-retry-log.md` | Separate text-only OpenRouter follow-up across UniMoral RQ1-RQ4, ValuePrism, and CCD-Bench: `102/119` model-task rows are scored. Provider/credit blockers stay documented as non-scored evidence limits. This package excludes SMID, DeNEVIL, and MiniMax; CCD-Bench is valid-choice behavior, not accuracy. | `within_family_scaling.svg`, `time_scaling.svg`, `benchmark_score_matrix.svg`, and `pilot_scores.svg` under `results/openrouter-selected-grid-moral-psych-full/figures/`. This follow-up is already tracked; `make release` rebuilds the frozen Option 1 release surfaces but does not rerun OpenRouter calls. |",
            "| Paper calibration tables + same-model CCD bar chart | `results/release/2026-04-19-option1/paper-result-alignment.csv`<br/>`results/release/2026-04-19-option1/paper-result-comparison.csv`<br/>`results/release/2026-04-19-option1/paper-model-overlap-map.csv`<br/>`results/release/2026-04-19-option1/paper-model-calibration-ledger.csv`<br/>`results/release/2026-04-19-option1/paper-model-calibration-bridge.csv`<br/>`docs/paper-result-comparison.md`<br/>`docs/calibration-replication.md`<br/>`docs/paper-model-replication-map.md` | Machine-readable calibration context stays in the tables. The bar chart plots only the 11 exact same-model CCD rows where paper and repo values share the same metric scale. | `option1_paper_result_alignment_map.svg` for the same-model CCD bar chart; `option1_paper_model_calibration_bridge.svg` for the detailed exact-model bridge; `option1_paper_result_comparison.svg` for context-only paper anchors. Rebuild through the same `make release` path. |",
            "",
            f"Quick visual links: {markdown_link('UniMoral heatmap', f'{figure_prefix}/option1_unimoral_task_heatmap.svg')}, {markdown_link('SMID/Value bars', f'{figure_prefix}/option1_benchmark_accuracy_bars.svg')}, {markdown_link('CCD choice map', f'{figure_prefix}/option1_ccd_choice_distribution.svg')}, {markdown_link('same-model CCD bar chart', f'{figure_prefix}/option1_paper_result_alignment_map.svg')}, {markdown_link('same-model calibration bridge', f'{figure_prefix}/option1_paper_model_calibration_bridge.svg')}, {markdown_link('paper result context', f'{figure_prefix}/option1_paper_result_comparison.svg')}, [selected-grid family scaling](../../openrouter-selected-grid-moral-psych-full/figures/within_family_scaling.svg), [selected-grid time scaling](../../openrouter-selected-grid-moral-psych-full/figures/time_scaling.svg), [selected-grid benchmark matrix](../../openrouter-selected-grid-moral-psych-full/figures/benchmark_score_matrix.svg), [selected-grid detailed task matrix](../../openrouter-selected-grid-moral-psych-full/figures/pilot_scores.svg).",
            "",
        ]
    )
...
def append_deliverables_for_today_section(lines: list[str], readiness_tier_matrix: list[dict[str, Any]]) -> None:
    ...
    lines.extend(
        [
            ...
            "| Paper comparison / calibration map | What exact same-model evidence exists, and what remains blocked or non-comparable? | [paper-model-calibration-bridge.csv](results/release/2026-04-19-option1/paper-model-calibration-bridge.csv), [paper-model-calibration-ledger.csv](results/release/2026-04-19-option1/paper-model-calibration-ledger.csv), [exact UniMoral Llama calibration](results/paper-calibration-exact-20260706-unimoral-llama31/calibration-summary.csv), [exact CCD calibration](results/paper-calibration-exact-20260705/calibration-summary.csv), and [paper-result-comparison.md](docs/paper-result-comparison.md). Use [paper-result-alignment.csv](results/release/2026-04-19-option1/paper-result-alignment.csv) only as a status ledger, not as the same-model bar comparison. |",
...
def append_readiness_and_replication_section(lines: list[str], readiness_tier_matrix: list[dict[str, Any]]) -> None:
    ...
    lines.extend(
        [
            ...
            "| --- | --- | --- |",
            "| `UniMoral` | Fresh exact Llama 3.1 8B RQ1-RQ4 rerun: RQ1 accuracy 0.621926, RQ2 accuracy 0.602234, RQ3 accuracy 0.594788, RQ4 live METEOR 0.121226, and RQ4 offline BERTScore F1 0.655539; visible paper metric anchors are tracked in `paper-result-comparison.csv`. | Same-model calibration is available, with metric-scale caveats. |",
...
def build_repo_readme(
    ...
    lines = [
        ...
        "",
        "## Visual Read In 90 Seconds",
        "",
        "Use this path when a reviewer or team lead wants the story before the tables. These links jump to the same figures embedded later in this README, so the top stays skimmable while the full visual evidence remains on-page.",
        "",
        "| Step | Open | Say this plainly |",
        "| ---: | --- | --- |",
        "| 1 | [UniMoral family-size scaling](figures/release/option1_unimoral_family_scaling.svg) | Moral reasoning is task-specific: RQ1-RQ3 use accuracy, RQ4 uses BERTScore F1 and METEOR, and GPT-5 is the black text-only S/M/L line. |",
        "| 2 | [SMID/Value accuracy bars](figures/release/option1_benchmark_accuracy_bars.svg) | The clean comparable accuracy readout uses UniMoral action, SMID, and Value separately; SMID is the current visual-moral bottleneck. |",
        "| 3 | [CCD choice distribution](figures/release/option1_ccd_choice_distribution.svg) | CCD-Bench shows cultural-choice behavior relative to a 10% uniform baseline, not right/wrong accuracy. |",
        "| 4 | [same-model CCD calibration bars](figures/release/option1_paper_result_alignment_map.svg) and [calibration bridge](figures/release/option1_paper_model_calibration_bridge.svg) | Calibration bars include only exact same-model/same-metric rows; non-exact, blocked, metric-mismatched, and proxy rows stay in tables. |",
        "| 5 | [DeNEVIL proxy behavior](figures/release/option1_denevil_behavior_outcomes.svg) | DeNEVIL is visible proxy behavior from saved traces, not paper-faithful MoralPrompt scoring and not Tier 3. |",
        "",
        "## Best Results At A Glance",
        "",
        "| Reader question | Current answer | Where to verify |",
        "| --- | --- | --- |",
        f"| Best fully observed comparable line | `{best_all['line_label']}`: UniMoral RQ1/action {fmt_float(best_all['unimoral_action_accuracy'])}, SMID {fmt_float(best_all['smid_average_accuracy'])}, Value {fmt_float(best_all['value_average_accuracy'])}; three-metric mean {fmt_float(best_all_mean)}. | [UniMoral CSV](results/release/2026-04-19-option1/unimoral-full-benchmark.csv), [SMID CSV](results/release/2026-04-19-option1/smid-results.csv), [Value CSV](results/release/2026-04-19-option1/value-kaleidoscope-results.csv), [SMID/Value bars](figures/release/option1_benchmark_accuracy_bars.svg) |",
        ...
        "### Figure Shortcuts",
        "",
        "For a 3-minute skim, use only the first shortcut row. The longer table underneath is a map for follow-up questions, not a requirement to read every chart.",
        "",
        "| If you have... | Open these first | What to say |",
        "| --- | --- | --- |",
        "| 3 minutes | [UniMoral family-size scaling](figures/release/option1_unimoral_family_scaling.svg), [Comparable accuracy bars](figures/release/option1_benchmark_accuracy_bars.svg), [CCD choice distribution](figures/release/option1_ccd_choice_distribution.svg) | Text reasoning, SMID/Value accuracy, and CCD cultural-choice behavior are separate result layers. |",
        ...
        "",
        "| Category | Open in this order | Figure | What it answers |",
        "| --- | ---: | --- | --- |",
        "| Headline | 1 | [UniMoral family-size scaling](figures/release/option1_unimoral_family_scaling.svg) | Do model families change consistently from S to M to L across RQ1-RQ4? |",
        "| UniMoral deep dive | 2 | [UniMoral four-task dashboard](figures/release/option1_unimoral_four_task_dashboard.svg) | What is covered across RQ1-RQ4, and which metric family applies to each task? |",
        "| UniMoral deep dive | 3 | [UniMoral task heatmap](figures/release/option1_unimoral_task_heatmap.svg) | Which model line is strongest for action prediction, moral typology, and factor attribution? |",
        "| UniMoral deep dive | 4 | [UniMoral RQ4 generation quality](figures/release/option1_unimoral_generation_quality.svg) | Which model line best generates plausible consequences under BERTScore F1 and METEOR? |",
        "| UniMoral deep dive | 5 | [UniMoral task rankings](figures/release/option1_unimoral_task_rankings.svg) | Which model lines lead each UniMoral task surface? |",
        "| UniMoral deep dive | 6 | [UniMoral task spread](figures/release/option1_unimoral_task_spread.svg) | How wide is the score spread across UniMoral classification tasks? |",
        "| Headline | 7 | [Comparable accuracy bars](figures/release/option1_benchmark_accuracy_bars.svg) | Which rows are strongest on SMID and Value after the separate UniMoral result block? |",
        "| Headline | 8 | [Comparable accuracy heatmap](figures/release/option1_accuracy_heatmap.svg) | Where are the comparable UniMoral, SMID, and Value cells present, missing, or withdrawn? |",
        "| Headline | 9 | [Comparable score spread](figures/release/option1_benchmark_difficulty_profile.svg) | Which comparable metric is the visual bottleneck, and where is cross-line spread largest? |",
        "| Deep dive | 10 | [Family scaling profile](figures/release/option1_family_scaling_profile.svg) | Where does size help or stall on SMID and Value Kaleidoscope? |",
        "| Behavior | 11 | [CCD choice distribution](figures/release/option1_ccd_choice_distribution.svg) | Which cultural-cluster choices are over-selected relative to a 10% uniform baseline? |",
        "| Behavior | 12 | [CCD dominant-option share](figures/release/option1_ccd_dominant_option_share.svg) | How concentrated is each line's dominant cultural-cluster choice? |",
        "| Proxy behavior | 13 | [DeNEVIL behavior outcomes](figures/release/option1_denevil_behavior_outcomes.svg) | What proxy behavior mix appears in the saved traces? |",
        "| Proxy behavior | 14 | [DeNEVIL prompt-family heatmap](figures/release/option1_denevil_prompt_family_heatmap.svg) | Which proxy prompt families trigger safer or riskier visible behavior? |",
        "| Calibration | 15 | [Same-model CCD calibration bar chart](figures/release/option1_paper_result_alignment_map.svg) | For the 11 exact same-model CCD rows, how do paper/source Nordic-share bars compare with this repo's exact rerun or verified row? |",
        "| Calibration | 16 | [Same-model paper calibration bridge](figures/release/option1_paper_model_calibration_bridge.svg) | Which exact paper-model rows can be compared, and which non-exact/proxy rows stay out of the visual comparison? |",
        "| Calibration context | 17 | [Paper-result context table](figures/release/option1_paper_result_comparison.svg) | What paper metric anchors exist, even when they are context rather than direct bar comparisons? |",
        "",
        ...
        "Legacy generated PNGs            figures/generated/ (not the current release surface)",
        ...
        f"- The {len(OPENAI_TEXT_REFERENCE_SPECS)} OpenAI text-only rows are reference rows; they do not add SMID or DeNEVIL coverage and are not paper-model calibration rows.",
...
def build_release_readme(
    ...
    lines.extend(
        [
            ...
            f"- {markdown_link('comparable score spread', '../../../figures/release/option1_benchmark_difficulty_profile.svg')}: mean and spread for the directly comparable benchmark groups",
            ...
            f"- {markdown_link('same-model CCD calibration bar chart', '../../../figures/release/option1_paper_result_alignment_map.svg')}: strict bar comparison for the 11 exact CCD-Bench paper-model rows with a shared Nordic-share metric",
    ...
    lines.extend(
        [
            ...
            "- `unimoral-full-benchmark.csv`: UniMoral RQ1-RQ4 result table, with RQ4 split into BERTScore F1 and METEOR rows",
            ...
            "- `paper-result-alignment.csv`: paper-vs-ours alignment table, including original/reference model evidence, overlap status, blocked/proxy states, and safe comparison boundaries",
...
def main() -> None:
    ...
    render_paper_result_alignment_svg(
        paper_model_calibration_bridge,
        args.figure_dir / "option1_paper_result_alignment_map.svg",
    )
