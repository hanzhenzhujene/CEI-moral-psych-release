...
def append_figure_gallery(lines: list[str], figure_prefix: str) -> None:
    lines.extend(
        [
            ...
            f"| Figure 17 | Same-model CCD-Bench calibration bars showing paper/source Nordic share beside exact current rerun or verified rows. | {markdown_link('option1_paper_result_alignment_map.svg', f'{figure_prefix}/option1_paper_result_alignment_map.svg')} |",
...
def append_main_result_file_map(lines: list[str], figure_prefix: str) -> None:
    lines.extend(
        [
            ...
            "| Paper calibration tables + same-model CCD bars | `results/release/2026-04-19-option1/paper-result-alignment.csv`<br/>`results/release/2026-04-19-option1/paper-result-comparison.csv`<br/>`results/release/2026-04-19-option1/paper-model-overlap-map.csv`<br/>`results/release/2026-04-19-option1/paper-model-calibration-ledger.csv`<br/>`results/release/2026-04-19-option1/paper-model-calibration-bridge.csv`<br/>`docs/paper-result-comparison.md`<br/>`docs/calibration-replication.md`<br/>`docs/paper-model-replication-map.md` | Machine-readable calibration context stays in the tables. The bar figure plots only the 11 exact same-model CCD rows where paper and repo values share the same metric scale. | `option1_paper_result_alignment_map.svg` for same-model CCD bars; `option1_paper_model_calibration_bridge.svg` for the detailed exact-model bridge; `option1_paper_result_comparison.svg` for context-only paper anchors. Rebuild through the same `make release` path. |",
            "",
            f"Quick visual links: {markdown_link('UniMoral heatmap', f'{figure_prefix}/option1_unimoral_task_heatmap.svg')}, {markdown_link('SMID/Value bars', f'{figure_prefix}/option1_benchmark_accuracy_bars.svg')}, {markdown_link('CCD choice map', f'{figure_prefix}/option1_ccd_choice_distribution.svg')}, {markdown_link('same-model CCD bars', f'{figure_prefix}/option1_paper_result_alignment_map.svg')}, {markdown_link('same-model calibration bridge', f'{figure_prefix}/option1_paper_model_calibration_bridge.svg')}, {markdown_link('paper result context', f'{figure_prefix}/option1_paper_result_comparison.svg')}, [selected-grid family scaling](../../openrouter-selected-grid-moral-psych-full/figures/within_family_scaling.svg), [selected-grid time scaling](../../openrouter-selected-grid-moral-psych-full/figures/time_scaling.svg), [selected-grid benchmark matrix](../../openrouter-selected-grid-moral-psych-full/figures/benchmark_score_matrix.svg).",
            "",
        ]
    )
