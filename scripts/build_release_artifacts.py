...
def append_figure_gallery(lines: list[str], figure_prefix: str) -> None:
    lines.extend(
        [
            "## Supporting Figures",
            "",
            "Figures 1 through 13 and the same-model calibration bars are already embedded above in context; this gallery keeps the full set together without repeating the surrounding interpretation text.",
            "",
...
def build_repo_readme(
    ...
    lines = [
        ...
        "| 9 | [Same-model CCD calibration bar chart](figures/release/option1_paper_result_alignment_map.svg) | For the 11 exact same-model CCD rows, how do paper/source Nordic-share bars compare with this repo's exact rerun or verified row? |",
