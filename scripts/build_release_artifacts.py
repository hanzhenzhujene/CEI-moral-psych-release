...
PAPER_RESULT_ALIGNMENT_ROWS = [
    {
        ...
        "same_model_overlap_or_context": "Saved/prior exact overlap exists for Llama 3.1 8B, but this PR does not contain a fresh full original-paper-model rerun. DeepSeek current rows are context only because they are not the same as the paper-named 8B distill route.",
