...
PAPER_MODEL_OVERLAP_ROW_VALUES = [
    ...
    ("UniMoral", "Llama-3.1-8B Instruct", "RQ1-RQ4 paper tables include this model", "Fresh exact Llama 3.1 8B UniMoral rerun", "RQ1 accuracy 0.6219; RQ2 accuracy 0.6022; RQ3 accuracy 0.5948; RQ4 live METEOR 0.1212", "Exact same-model fresh rerun evidence with metric-scale caveats", "Use as UniMoral model-identity calibration; do not call it reproduced paper weighted-F1/BERTScore without the matching offline scorer."),
...
PAPER_MODEL_CALIBRATION_LEDGER_ROWS = [
    {
        ...
        "repo_result_anchor": "Fresh exact UniMoral rerun: RQ1 accuracy 0.621926; RQ2 accuracy 0.602234; RQ3 accuracy 0.594788; RQ4 live METEOR 0.121226. Offline BERTScore is not yet recomputed for this fresh run.",
        ...
        "calibration_action": "Use as fresh exact same-model UniMoral calibration with metric-scale caveats; run offline BERTScore before citing a paper-style RQ4 semantic score.",
        "comparison_boundary": "Same model and same task family, but paper reports weighted F1 / 0-100 generation metrics while the repo reports accuracy and 0-1 live METEOR; BERTScore remains pending for the fresh run.",
    },
    {
        "benchmark": "UniMoral RQ1-RQ4",
...
PAPER_MODEL_CALIBRATION_BRIDGE_ROWS = [
    {
        ...
        "fresh_rerun": "yes",
        "task_scope": "RQ1-RQ4 fresh exact rerun; RQ4 live METEOR only until offline BERTScore is recomputed",
        ...
        "repo_value": "RQ1 0.621926; RQ2 0.602234; RQ3 0.594788; RQ4 METEOR 0.121226",
        "valid_n": "17550",
        "total_n": "17550",
