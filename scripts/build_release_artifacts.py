...
PAPER_RESULT_ALIGNMENT_ROWS = [
    ...
    },
    {
        ...
        "current_repo_result_surface": "Current release reports line-level CCD choice distributions in ccd-choice-distribution.csv, not accuracy. The strict same-model calibration bridge now includes exact current Llama-3.3, exact current Llama-4, and fresh exact CCD reruns for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, Perplexity Sonar, and Claude 4 Sonnet.",
        "same_model_overlap_or_context": "Exact overlap exists for saved/prior Mistral Nemo, current Llama-3.3-70B-Instruct / Llama-M, current Llama-4-Maverick-17B-128E-Instruct / Llama-L, and fresh July 2026 exact CCD reruns for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, Perplexity Sonar, and Claude 4 Sonnet.",
        "paper_only_models_or_routes": "Remaining unverified or unavailable exact routes include ChatGPT-4o-latest, Gemini 2.0/2.5 Flash, Claude 3.7 Sonnet, Jamba 1.6, Grok-2, and WizardLM full distribution after the cancelled attempt.",
        ...
        "can_compare_directly": "Partly. The same-model bridge includes saved/prior Mistral Nemo, current Llama-3.3-70B-Instruct, current Llama-4-Maverick-17B-128E-Instruct, and fresh verified CCD distribution rows for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, GPT-4.1, Command-R, Phi-4, Sonar, and Claude 4 Sonnet; the metric is distribution/concentration rather than accuracy. Non-exact rows stay out of one-to-one calibration visuals.",
...
PAPER_RESULT_COMPARISON_ROWS = [
    ...
    },
    {
        ...
        "our_exact_result": "Same-model rows include Mistral Nemo saved/prior, Llama-3.3 and Llama-4 current release rows, and fresh July 2026 exact CCD reruns: DeepSeek 23.2%, Qwen 21.1%, GPT-4.1 22.3%, Command-R 22.7%, Phi-4 20.7%, Sonar 14.3%, and Claude 4 Sonnet 30.2% Nordic Europe dominant-cluster share.",
        "our_closest_line": "Strict bridge rows: Mistral Nemo saved/prior, Llama-M/Llama-L current release, and fresh exact CCD reruns",
        "comparison_status": "Same-model behavioral bridge; CCD-Bench is not accuracy",
        "same_model_overlap": "Exact same-model overlap exists for saved/prior Mistral Nemo, current Llama-3.3-70B-Instruct / Llama-M, current Llama-4-Maverick-17B-128E-Instruct / Llama-L, and fresh July 2026 exact reruns for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, Perplexity Sonar, and Claude 4 Sonnet.",
...
PAPER_MODEL_OVERLAP_ROW_VALUES = [
    ...
    ("CCD-Bench", "WizardLM-2-8x22B", "top Nordic Europe 22.0%; Germanic Europe 16.4%; plural rationales 88.8%; Cramer's V 0.111", "Cancelled local attempt", "Partial/cancelled attempt only; no verified full distribution row", "Cancelled partial run; not plotted in the same-model calibration bridge", "Rerun only if bandwidth allows; do not treat the partial attempt as calibration evidence."),
    ("CCD-Bench", "Mistral Nemo", "top Nordic Europe 19.0%; Germanic Europe 13.1%; plural rationales 82.0%; Cramer's V 0.130", "May 13 exploratory Mistral Nemo", "CCD Nordic Europe 25.3%; effective clusters 7.22", "Exact same-model saved/prior evidence outside the current family-size release table", "Use as a clearly labeled same-model follow-up row, not as a fresh rerun."),
...
PAPER_MODEL_CALIBRATION_LEDGER_ROWS = [
    ...
    },
    {
        ...
        "repo_result_anchor": "Cancelled local attempt only; no verified full distribution row.",
        "repo_evidence_state": "attempt_cancelled_partial_not_verified",
        "repo_evidence_path": "results/paper-calibration-exact-20260705/calibration-summary.csv",
        "calibration_action": "Leave out of the strict bridge; rerun only if bandwidth allows.",
        "comparison_boundary": "CCD is distributional behavior, not accuracy; cancelled partial attempts are not calibration evidence.",
    },
    {
        "benchmark": "CCD-Bench",
