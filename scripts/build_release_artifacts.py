...
PAPER_RESULT_ALIGNMENT_ROWS = [
    ...
    },
    {
        ...
        "current_repo_result_surface": "Current release reports line-level CCD choice distributions in ccd-choice-distribution.csv, not accuracy. The strict same-model calibration bridge now adds fresh exact CCD reruns for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, Perplexity Sonar, and Claude 4 Sonnet.",
        "same_model_overlap_or_context": "Exact overlap exists for saved/prior Mistral Nemo, the current Llama-3.3-70B-Instruct / Llama-M row, and fresh July 2026 exact CCD reruns for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, Perplexity Sonar, and Claude 4 Sonnet.",
        ...
        "can_compare_directly": "Partly. The same-model bridge includes saved/prior Mistral Nemo, current Llama-3.3-70B-Instruct, and fresh verified CCD distribution rows for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, GPT-4.1, Command-R, Phi-4, Sonar, and Claude 4 Sonnet; the metric is distribution/concentration rather than accuracy. Near-family rows stay out of one-to-one calibration visuals.",
        ...
        "reviewer_takeaway": "CCD-Bench needs a visual/map rather than a winner table: compare only exact same-model distribution evidence when calibrating to the paper, keep failed/cancelled/near-family rows as ledger context only, and remove all accuracy language.",
...
PAPER_RESULT_COMPARISON_ROWS = [
    ...
    },
    {
        ...
        "our_exact_result": "Same-model rows include Mistral Nemo saved/prior, Llama-3.3 current release, and fresh July 2026 exact CCD reruns: DeepSeek 23.2%, Qwen 21.1%, GPT-4.1 22.3%, Command-R 22.7%, Phi-4 20.7%, Sonar 14.3%, and Claude 4 Sonnet 30.2% Nordic Europe dominant-cluster share.",
        "our_closest_line": "Strict bridge rows: Mistral Nemo saved/prior, Llama-M current release, and fresh exact CCD reruns",
        "comparison_status": "Same-model behavioral bridge; CCD-Bench is not accuracy",
        "same_model_overlap": "Exact same-model overlap exists for saved/prior Mistral Nemo, current Llama-3.3-70B-Instruct / Llama-M, and fresh July 2026 exact reruns for DeepSeek-chat-v3-0324, Qwen2.5-72B-Instruct, OpenAI GPT-4.1, Command-R 08-2024, Microsoft Phi-4, Perplexity Sonar, and Claude 4 Sonnet.",
        "reviewer_takeaway": "Use the strict bridge for one-to-one CCD distribution calibration. Treat cancelled, failed, unavailable, and near-family rows as ledger context only.",
