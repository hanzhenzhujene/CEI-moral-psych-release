...
run_family() {
  ...
  case "$family" in
    qwen_text)
      ...
      run_task "$family" "unimoral_moral_typology" "src/inspect/evals/unimoral.py::unimoral_moral_typology" "openrouter/qwen/qwen3-8b" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_factor_attribution" "src/inspect/evals/unimoral.py::unimoral_factor_attribution" "openrouter/qwen/qwen3-8b" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_consequence_generation" "src/inspect/evals/unimoral.py::unimoral_consequence_generation" "openrouter/qwen/qwen3-8b" "$TEXT_MAX_CONNECTIONS"
    ...
    deepseek_text)
      ...
      run_task "$family" "unimoral_moral_typology" "src/inspect/evals/unimoral.py::unimoral_moral_typology" "openrouter/deepseek/deepseek-chat-v3.1" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_factor_attribution" "src/inspect/evals/unimoral.py::unimoral_factor_attribution" "openrouter/deepseek/deepseek-chat-v3.1" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_consequence_generation" "src/inspect/evals/unimoral.py::unimoral_consequence_generation" "openrouter/deepseek/deepseek-chat-v3.1" "$TEXT_MAX_CONNECTIONS"
    ...
    gemma_text)
      ...
      run_task "$family" "unimoral_moral_typology" "src/inspect/evals/unimoral.py::unimoral_moral_typology" "$GEMMA_TEXT_MODEL" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_factor_attribution" "src/inspect/evals/unimoral.py::unimoral_factor_attribution" "$GEMMA_TEXT_MODEL" "$TEXT_MAX_CONNECTIONS"
      run_task "$family" "unimoral_consequence_generation" "src/inspect/evals/unimoral.py::unimoral_consequence_generation" "$GEMMA_TEXT_MODEL" "$TEXT_MAX_CONNECTIONS"
